...
<head>
  ...
  <title>Admin Dashboard - AKABOEZEM </title>
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Web Components</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Nav Bars</span>
            </a>
          </li>
          <li>
            <a href="#">
          ...
          <li>
            <a href="#">
              <i class="bi bi-circle"></i><span>Recent Photo</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="{{ Route('admin.notification') }}">
          <i class="bi bi-bell"></i>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Common Digital Sense</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Designed with <a href="#">BootstrapMade</a>
    </div>
  </footer><!-- End Footer -->
