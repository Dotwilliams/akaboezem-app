              ...
              <form class="pt-3" method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="name" placeholder="Name" name="name" required>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="email" class="form-control form-control-lg border-left-0" id="email" placeholder="Email" name="email"  required>
                  </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="password" class="form-control form-control-lg border-left-0" id="password_confirmation" placeholder="Confirm Password"   name="password_confirmation" 
                      required>                        
                    </div>
                  </div>
                ...
                {{-- button --}}
                <div class="mt-3">
                    <input type="submit" class="btn btn-block btn-primary btn-lg font-weight-large auth-form-btn" value=" {{ __('Register') }}" />
